...
def main():
    ...
    for line in stdout_lines:
        if re.match("TEST_CSIM_RESULTS", line):
            ...
            if line: # Avoid printing empty trailing lines
                print("%s" % (line))
    ...
    try:
        ...
        if not csim_cscore: csim_cscore = [0] # Handle failure case
        ...
        print("Error: Could not parse results. Make sure ./test-csim and ./test-trans are compiled and running.")
        sys.exit(1)
